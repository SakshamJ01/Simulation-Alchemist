...
def test_workbench_homepage_loads() -> None:
...
def test_workbench_api_endpoints() -> None:
    with sync_playwright() as p:
        request_context = p.request.new_context(base_url="http://127.0.0.1:5000", timeout=90000)
