...
def _serialize_trajectory(trajectory: Any, max_visual_frames: int = 250) -> dict[str, Any]:
    """Extract and serialize real trajectory frames for frontend visualization with adaptive decimation."""
    ...
    # For Experiment A (walls) synchronously across step_indices
